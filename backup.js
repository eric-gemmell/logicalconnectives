...
//this function is the start of the overall script.
function Start(){
	var pre_loaded_clauses = [],
	pre_loaded_links = [];
	pre_loaded_clauses.push({"id" : CLAUSE_ID++,"text": "Suffering is always bad","pos":{"x":INIT_X,"y":INIT_Y},"active":false, "links":[]},
	{"id" : CLAUSE_ID++,"text": "Suffering can be bad","pos":{"x":INIT_X+200,"y":INIT_Y+50},"active":true,"links":[]},
	{"id" : CLAUSE_ID++,"text": "Suffering is always good","pos":{"x":INIT_X+600,"y":INIT_Y},"active":false,"links":[]},
	{"id" : CLAUSE_ID++,"text": "Suffering can be good","pos":{"x":INIT_X+400,"y":INIT_Y+50},"active":true,"links":[]},
	{"id" : CLAUSE_ID++,"text": "Suffering can be both good and bad","pos":{"x":INIT_X+300,"y":INIT_Y+200},"active":true,"links":[]}
	);
	pre_loaded_links.push({"type":"implication","sources":[0],"destinations":[1]},
	{"type":"implication","sources":[2],"destinations":[3]}
	);
	pre_loaded_clauses.forEach(function(clause){ CreateClause(clause);});
	pre_loaded_links.forEach(function(link){ Create_Link(link.type,link.sources,link.destinations);});
}
Start();
